...
return static function (Router $router): void {
    $router->add('POST', '/api/admin/login', [AuthController::class, 'adminLogin'], ['public' => true]);
    $router->add('POST', '/api/user/login', [AuthController::class, 'mailboxLogin'], ['public' => true]);
    $router->add('POST', '/api/user/password/change', [AuthController::class, 'mailboxPasswordChange'], ['public' => true]);
    $router->add('POST', '/api/webmail/password-change', [AuthController::class, 'mailboxPasswordChange'], ['public' => true]);
